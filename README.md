...
Please find the complete documentation on the [panther website](https://www.panther.io).
...
- [x] **Edge position sizing** Calculate your win rate, risk reward ratio, the best stoploss and adjust your position size before taking a position for each specific market. [Learn more](https://www.panther.io/en/stable/edge/).
...
For any other type of installation please refer to [Installation doc](https://www.panther.io/en/stable/installation/).
...
Telegram is not mandatory. However, this is a great way to control your bot. More details and the full command list on the [documentation](https://www.panther.io/en/latest/telegram-usage/)
