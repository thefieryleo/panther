...
from panther.constants import DATETIME_PRINT_FORMAT, LAST_BT_RESULT_FN
from panther.data import history
from panther.data.btanalysis import (get_latest_backtest_filename, load_backtest_data,
                                       load_backtest_stats)
from panther.edge import PairInfo
from panther.enums import SellType
from panther.optimize.optimize_reports import (_get_resample_from_period, generate_backtest_stats,
...
def test_store_backtest_stats(testdatadir, mocker):
    ...
    dump_mock = mocker.patch('panther.optimize.optimize_reports.file_dump_json')
