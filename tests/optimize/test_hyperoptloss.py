...
from panther.optimize.hyperopt_loss_short_trade_dur import ShortTradeDurHyperOptLoss
...
def test_hyperoptlossresolver(mocker, default_conf) -> None:
    ...
    mocker.patch(
        'panther.resolvers.hyperopt_resolver.HyperOptLossResolver.load_object',
