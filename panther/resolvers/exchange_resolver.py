...
import panther.exchange as exchanges
from panther.exchange import MAP_EXCHANGE_CHILDCLASS, Exchange
from panther.resolvers import IResolver
...
class ExchangeResolver(IResolver):
    ...
    def _load_exchange(exchange_name: str, kwargs: dict) -> Exchange:
        ...
        Only checks for exchanges exported in panther.exchanges
