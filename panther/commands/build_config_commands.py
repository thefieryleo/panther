...
from panther.configuration.directory_operations import chown_user_directory
from panther.constants import UNLIMITED_STAKE_AMOUNT
from panther.exceptions import OperationalException
from panther.exchange import MAP_EXCHANGE_CHILDCLASS, available_exchanges
from panther.misc import render_template
...
def ask_user_config() -> Dict[str, Any]:
    ...
    questions: List[Dict[str, Any]] = [
        ...
        },
        {
            "type": "confirm",
            "name": "api_server",
            "message": "Do you want to enable the Rest API (includes PantherUI)?",
            "default": False,
        },
        {
            "type": "text",
