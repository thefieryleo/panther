...
from panther.configuration.directory_operations import copy_sample_files, create_userdata_dir
...
from panther.misc import render_template, render_template_with_fallback
...
def get_ui_download_url(version: Optional[str] = None) -> Tuple[str, str]:
    base_url = 'https://api.github.com/repos/thefieryleo/pantherui/'
...
def start_install_ui(args: Dict[str, Any]) -> None:
    ...
    if curr_version == latest_version and not args.get('erase_ui_only'):
        logger.info(f"UI already up-to-date, PantherUI Version {curr_version}.")
        return
