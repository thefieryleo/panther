...
from panther.constants import ListPairsWithTimeframes
from panther.data.dataprovider import DataProvider
from panther.enums import SellType, SignalTagType, SignalType
from panther.exceptions import OperationalException, StrategyError
from panther.exchange import timeframe_to_minutes, timeframe_to_seconds
from panther.exchange.exchange import timeframe_to_next_date
from panther.persistence import PairLocks, Trade
from panther.strategy.hyper import HyperStrategyMixin
from panther.strategy.informative_decorator import (InformativeData, PopulateIndicators,
...
class IStrategy(ABC, HyperStrategyMixin):
    """
    Interface for panther strategies
...
###
    ...
    def unlock_pair(self, pair: str) -> None:
        ...
        Not used by panther itself, but intended to be used if users lock pairs
