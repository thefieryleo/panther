"""
Various tool function for Panther and scripts
"""
import gzip
import hashlib
import logging
...
from panther.constants import DECIMAL_PER_COIN_FALLBACK, DECIMALS_PER_COIN
...
def render_template(templatefile: str, arguments: dict = {}) -> str:
    ...
    env = Environment(
        loader=PackageLoader('panther', 'templates'),
