...
from panther.misc import round_dict
...
class IHyperOpt(ABC):
    """
    Interface for panther hyperopt
    ...
    def roi_space(self) -> List[Dimension]:
        ...
        It's used by Panther by default, if no custom roi_space method is defined.
        """
        ...
        #
        # The scaling is designed so that it maps exactly to the legacy Panther roi_space()
