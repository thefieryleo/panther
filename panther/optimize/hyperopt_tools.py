...
from panther.constants import FTHYPT_FILEVERSION, USERPATH_STRATEGIES
from panther.exceptions import OperationalException
from panther.misc import deep_merge_dicts, round_coin_value, round_dict, safe_value_fallback2
from panther.optimize.hyperopt_epoch_filters import hyperopt_filter_epochs
        ...
        for epochs_tmp in HyperoptTools._read_results(results_file):
            if total_epochs == 0 and epochs_tmp[0].get('is_best') is None:
                raise OperationalException(
                    ...
                    "of Panther and cannot be loaded.")
