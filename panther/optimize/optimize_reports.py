...
from panther.constants import DATETIME_PRINT_FORMAT, LAST_BT_RESULT_FN, UNLIMITED_STAKE_AMOUNT
from panther.data.btanalysis import (calculate_csum, calculate_market_change,
                                       calculate_max_drawdown)
from panther.misc import (decimals_per_coin, file_dump_json, get_backtest_metadata_filename,
                            round_coin_value)
...
def text_table_add_metrics(strat_results: Dict) -> str:
    if len(strat_results['trades']) > 0:
        ...
        # command stores these results and newer version of panther must be able to handle old
