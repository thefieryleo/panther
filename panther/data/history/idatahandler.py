...
from panther import misc
from panther.configuration import TimeRange
from panther.constants import ListPairsWithTimeframes, TradeList
from panther.data.converter import clean_ohlcv_dataframe, trades_remove_duplicates, trim_dataframe
from panther.exchange import timeframe_to_seconds
        ...
        if pairdf.empty:
            if warn_no_data:
                logger.warning(
                    ...
                    'Use `panther download-data` to download the data'
                )
            return True
        return False
