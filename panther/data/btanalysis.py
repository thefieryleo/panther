...
from panther.misc import get_backtest_metadata_filename, json_load
...
def evaluate_result_multi(results: pd.DataFrame, timeframe: str,
    ...
    :return: dataframe with open-counts per time-period in panther
    """
