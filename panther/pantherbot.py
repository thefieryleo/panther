"""
Panther is the main module of this bot. It contains the class Panther()
"""
import copy
import logging
import traceback
...
from panther import __version__, constants
from panther.configuration import validate_config_consistency
from panther.data.converter import order_book_to_dataframe
from panther.data.dataprovider import DataProvider
from panther.edge import Edge
...
from panther.exchange import timeframe_to_minutes, timeframe_to_seconds
from panther.misc import safe_value_fallback, safe_value_fallback2
from panther.mixins import LoggingMixin
from panther.persistence import Order, PairLocks, Trade, cleanup_db, init_db
from panther.plugins.pairlistmanager import PairListManager
from panther.plugins.protectionmanager import ProtectionManager
from panther.resolvers import ExchangeResolver, StrategyResolver
from panther.rpc import RPCManager
from panther.strategy.interface import IStrategy, SellCheckTuple
from panther.strategy.strategy_wrapper import strategy_safe_wrapper
from panther.wallets import Wallets


logger = logging.getLogger(__name__)


class PantherBot(LoggingMixin):
    """
    Panther is the main class of the bot.
    ...
    def __init__(self, config: Dict[str, Any]) -> None:
        ...
        logger.info('Starting panther %s', __version__)
        ...
        # initialization, even before Pantherbot has a chance to start its throttling,
        # so anything in the Pantherbot instance should be ready (initialized), including
    ...
    def process(self) -> None:
        ...
        # Without this, panther my try to recreate stoploss_on_exchange orders
