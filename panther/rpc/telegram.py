...
from panther.constants import DUST_PER_COIN
from panther.enums import RPCMessageType
from panther.exceptions import OperationalException
from panther.misc import chunks, plural, round_coin_value
from panther.persistence import Trade
from panther.rpc import RPC, RPCException, RPCHandler
...
class Telegram(RPCHandler):
    ...
    def _version(self, update: Update, context: CallbackContext) -> None:
        ...
        :return: None
        """
        strategy_version = self._rpc._panther.strategy.version()
    ...
    def _show_config(self, update: Update, context: CallbackContext) -> None:
        ...
        :return: None
        """
        val = RPC._rpc_show_config(self._config, self._rpc._panther.state)
