...
from panther.constants import USERPATH_STRATEGIES
from panther.data.history import get_datahandler
from panther.exceptions import OperationalException
from panther.rpc import RPC
from panther.rpc.api_server.api_schemas import (AvailablePairs, Balances, BlacklistPayload,
                                                  ...
                                                  WhitelistResponse)
from panther.rpc.api_server.deps import get_config, get_exchange, get_rpc, get_rpc_optional
...
def show_config(rpc: Optional[RPC] = Depends(get_rpc_optional), config=Depends(get_config)):
    ...
    if rpc:
        state = rpc._panther.state
        strategy_version = rpc._panther.strategy.version()
