...
from panther.rpc.rpc import RPC, RPCException, RPCHandler
...
class ApiServer(RPCHandler):
    ...
    def __init__(self, config: Dict[str, Any], standalone: bool = False) -> None:
        ...
        self.app = FastAPI(title="Panther API",
    ...
    def configure_app(self, app: FastAPI, config):
        from panther.rpc.api_server.api_auth import http_basic_or_jwt_token, router_login
        from panther.rpc.api_server.api_backtest import router as api_backtest
        from panther.rpc.api_server.api_v1 import router as api_v1
        from panther.rpc.api_server.api_v1 import router_public as api_v1_public
        from panther.rpc.api_server.web_ui import router_ui
