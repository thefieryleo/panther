...
from panther.configuration.config_validation import validate_config_consistency
from panther.enums import BacktestState
from panther.exceptions import DependencyException
from panther.rpc.api_server.api_schemas import BacktestRequest, BacktestResponse
from panther.rpc.api_server.deps import get_config
...
async def api_start_backtest(bt_settings: BacktestRequest, background_tasks: BackgroundTasks,
    ...
    def run_backtest():
        from panther.optimize.optimize_reports import (generate_backtest_stats,
