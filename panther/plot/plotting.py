...
from panther.data.btanalysis import (analyze_trade_parallelism, calculate_max_drawdown,
                                       calculate_underwater, combine_dataframes_with_mean,
                                       create_cum_profit, extract_trades_of_period, load_trades)
from panther.data.converter import trim_dataframe
from panther.data.dataprovider import DataProvider
from panther.data.history import get_timerange, load_data
from panther.exceptions import OperationalException
from panther.exchange import timeframe_to_prev_date, timeframe_to_seconds
from panther.misc import pair_to_filename
...
def generate_profit_graph(pairs: str, data: Dict[str, pd.DataFrame],
    ...
    fig['layout'].update(title="Panther Profit plot")
    fig['layout']['yaxis1'].update(title='Price')
...
def generate_plot_filename(pair: str, timeframe: str) -> str:
    ...
    file_name = 'panther-plot-' + pair_s + '-' + timeframe + '.html'
...
def plot_profit(config: Dict[str, Any]) -> None:
    ...
    store_plot_file(fig, filename='panther-profit-plot.html',
                    directory=config['user_data_dir'] / 'plot',
